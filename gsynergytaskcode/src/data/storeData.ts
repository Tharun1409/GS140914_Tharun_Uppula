...
{ id: "SK14051", label: "Crew Neck Merino Wool Sweater", class: "Tops", department: "Women's Apparel", price: "$19.99", cost: "$3.62" },
{ id: "SK14104", label: "Handcrafted Wooden Watch", class: "Bottoms", department: "Footwear", price: "$154.99", cost: "$122.91" },
{ id: "SK14223", label: "Smart Heated Gloves", class: "Tops", department: "Women's Apparel", price: "$34.99", cost: "$4.13" },
{ id: "SK14232", label: "Luxury Silk Tie", class: "Tops", department: "Sportswear", price: "$114.99", cost: "$49.68" },
{ id: "SK14409", label: "Heavy-Duty Work Gloves", class: "Tops", department: "Women's Apparel", price: "$164.99", cost: "$63.03" },
{ id: "SK14424", label: "Waterproof Hiking Boots", class: "Jewelry", department: "Men's Apparel", price: "$144.99", cost: "$17.25" },
{ id: "SK14528", label: "Performance Swim Trunks", class: "Footwear", department: "Unisex Accessories", price: "$114.99", cost: "$41.51" },
{ id: "SK14566", label: "Feather Embellished Fedora", class: "Outerwear", department: "Sportswear", price: "$184.99", cost: "$193.87" },
{ id: "SK14651", label: "Floral Chiffon Wrap Dress", class: "Tops", department: "Footwear", price: "$159.99", cost: "$110.23" },
{ id: "SK14807", label: "Bamboo Fiber Boxer Briefs", class: "Accessories", department: "Men's Apparel", price: "$89.99", cost: "$7.74" },
